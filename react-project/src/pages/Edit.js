...
function Edit (){
  ...
  submitUser() {
    if (this.state.firstname !== '' && this.state.lastname !== '' && this.state.email !== '' && this.state.password !== '' && this.state.avatar !== '') {
      ...
      let baseUrl = 'https://64b53279f3dbab5a95c6e9e2.mockapi.io/api/v1/user/'+this.props.id
      axios.put(`${baseUrl}`, bodyUser, {
        headers: {
        ...
        <div className="row main-sign-log">
          ...
          <div className="row d-flex justify-content-center">
            <div className="col-6 d-flex justify-content-evenly">
              <input className="btn" type="button" value="Edit" onClick={this.submitUser} />
            </div>
          </div>
        </div>
      </div>
